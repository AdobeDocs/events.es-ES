...
Mientras que Adobe Journey Optimizer proporciona una interfaz y un flujo de trabajo modernos y fáciles de usar para crear y administrar recorridos personalizados de clientes de 1:1 en tiempo real, las empresas también necesitan comunicar mensajes urgentes y críticos basados en señales urgentes y mensajes de autor a audiencias sin crear recorridos. Estos mensajes podrían incluir restablecimientos de contraseña, códigos de una sola vez o incluso actualizaciones posteriores al juego para la base de suscriptores de los aficionados al deporte.
...
Continuar la discusión sobre [publicación de la comunidad de Experience League](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-discussions/experience-league-live-post-session-discussion-api-triggered/m-p/614273?profile.language=es#M132).
