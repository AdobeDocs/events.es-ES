---
title: 'Resumen de verano: tres funciones que debe probar en Adobe Journey Optimizer'
description: 'Aumente la participación de sus clientes este verano con las tres funciones de Adobe Journey Optimizer: experimentación de recorridos, restricción de frecuencia y mensajería multilingüe.'
kt: 15471
...
# Resumen de verano: tres funciones que debe probar en Adobe Journey Optimizer
...
**Mostrar detalles**:
A medida que el verano se calienta, también aumentan las oportunidades de interactuar con sus clientes de formas nuevas e impactantes. Únase a nosotros durante una hora en Experience League Live para profesionales de Journey Optimizer, ya esté en operaciones de marketing, administración de campañas/recorridos o experiencia del cliente, donde profundizaremos en las potentes funciones de Adobe Journey Optimizer.
