---
title: Un salto adelante con la nueva interfaz de usuario web de Adobe Campaign
...
# Un salto adelante con la nueva interfaz de usuario web de Adobe Campaign
...
Continúe con la discusión de este tema en la [publicación de la comunidad](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic/experience-league-live-post-session-discussion-leaping-ahead/m-p/656893?profile.language=es#M2671){target="_blank"} de Adobe Experience League.
...
* Se ha lanzado la nueva interfaz de usuario web de Adobe Campaign, que está disponible para los clientes con la versión 8.6 de Adobe Campaign.
...
* La página de inicio de la interfaz de usuario web permite un acceso rápido a todas las aplicaciones de Experience Cloud y proporciona notificaciones y opciones de asistencia.
...
* **[Interfaz de usuario web de Adobe Campaign: tutoriales](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/overview.html?lang=es){target="_blank"}**
