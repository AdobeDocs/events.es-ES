---
title: Inside Mayo Clinic - Cómo Workfront Fusion ayuda a los humanos
description: Inside analiza 6 casos de uso diferentes sobre cómo Mayo Clinic utiliza Workfront Fusion para transformar su forma de trabajar.
...
# Inside Mayo Clinic: Cómo Workfront Fusion ayuda a los humanos

Alojada en colaboración con Tia Calvert y Matt Lien de Mayo Clinic, esta sesión proporcionó una visión interna de 6 casos de uso diferentes sobre cómo Mayo Clinic está usando Workfront Fusion para transformar la forma en que funcionan.
...
Fusion lleva tiempo y práctica, por lo que si acaba de empezar, obtenga más información sobre el (gratuito) [Formación de Fusion en Experience League](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/fusion/welcome-to-workfront-fusion/workfront-fusion-overview) y no dude en ponerse en contacto para obtener ayuda de otros clientes en la [Comunidad de Workfront Fusion](https://experienceleaguecommunities.adobe.com/t5/workfront-fusion/ct-p/workfront-fusion-2?profile.language=es).
