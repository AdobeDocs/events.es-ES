---
title: Preparación para la migración de Real-time Customer Data Platform
description: Descubra cómo migrar a Adobe Real-time CDP (RTCDP) y qué nivel de esfuerzo se requiere:- Migrar desde un CDP existente- Impacto en casos de uso existentes (Personalization y optimización)- Cambios organizativos necesarios para admitir la administración de datos de clientes en tiempo real.
...
# Preparación para la migración de Real-time Customer Data Platform

Descubra cómo migrar a la plataforma de datos del cliente en tiempo real de Adobe y qué nivel de esfuerzo se requiere,
...
* En la reunión se analizó la importancia de pasar de los CDP existentes, como Adobe Audience Manager, a los CDP en tiempo real, como el CDP en tiempo real de Adobe, para adaptarse a las tendencias del sector y prepararse para las futuras necesidades de administración de datos.
