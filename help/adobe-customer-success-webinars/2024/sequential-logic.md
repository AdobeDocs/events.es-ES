...
# Dominio de la lógica secuencial en AA y CJA: Foundations
...
* **Enfoque de la sesión** La sesión se centró en dominar la lógica secuencial y el análisis en Customer Journey Analytics (CJA), liderado por Andy Powers.
...
* **Recursos** Se proporcionaron vínculos a recursos para las partes de análisis y CJA de segmentos secuenciales o filtros para un estudio más detallado.
