...
El evento proporcionó actualizaciones sobre Adobe Experience Manager, incluida la introducción de la función Live Copy o Administrador de varios sitios, que permite a los usuarios administrar contenido en varias ubicaciones con variaciones fácilmente. Además, el evento mostró la nueva mejora de Firefly para la administración de recursos, que permite a los usuarios generar nuevos recursos cuando no se encuentran resultados de búsqueda. Además, se introdujeron plantillas de medios dinámicos para simplificar la creación de varios titulares con valores cambiantes de forma eficaz. El evento también destacó el nuevo Sistema Jenn-air para formularios AEM, que ofrece acceso a los primeros usuarios para acelerar los procesos de creación de formularios. Por último, se presentaron mejoras en Cloud Manager para racionalizar las implementaciones de proyectos, como la compatibilidad con los servicios de entrega perimetral y los certificados de base de datos validados por el dominio. &#x200B;
