            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="admin-console.md" title="Preparación para Marketo Engage en Adobe Identity" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3432370/?captions=spa&format=jpeg&nocache=1780010007038" alt="Preparación para Marketo Engage en Adobe Identity"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="api.md" title="API" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3430734/?captions=spa&format=jpeg&nocache=1780010007041" alt="API"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Automate & Innovate Building Smarter Flows with Webhooks & Self-Service Flow Steps (SSFS)">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="building-smarter-flows.md" target="_blank" rel="referrer" title="Automatice e innove la creación de flujos más inteligentes con webhooks y pasos de flujo de autoservicio (SSFS)">Automatice e innove la generación de flujos más inteligentes con webhooks y pasos de flujo de autoservicio (SSFS)</a>
                    </p>
                    <p class="is-size-6">Esta explicación detallada de Marketo abarca los webhooks y los pasos de flujo de autoservicio (SSFS) para ayudarle a crear una automatización de marketing más inteligente y compatible con IA. Conozca las prácticas recomendadas de configuración, las técnicas de integración en tiempo real y los casos de uso prácticos, incluidas las actualizaciones de CRM, el enriquecimiento de datos, la lógica de flujo personalizada y los flujos de trabajo con tecnología de IA. Perfecto para usuarios de Marketo, equipos de MOP y administradores centrados en una calidad de datos y resultados de campaña más sólidos.</p>
                </div>
