...
+ 2018 {#gems2018}
   ...
   + [Tiempo real y peso ligero: cree integraciones impulsadas por eventos con AEM mediante Adobe I/O Events](gems2018/aem-adobe-io.md)
   + [Eventos de Adobe Developer (IO): Déclencheur de Analytics](gems2018/aem-analytics-triggers.md)
   + [Experimentos en escalabilidad de autor de AEM](gems2018/aem-author-scalability1.md)
   + [Componentes principales de AEM](gems2018/aem-core-components.md)
   + [La explosión de recursos digitales &amp; [!DNL AEM Assets]](gems2018/aem-digital-asset-explosion.md)
   + [Introducción a ContextHub en AEM 6.4](gems2018/aem-intro-to-contexthub.md)
   + [Aprendizaje automático en AEM: etiquetas inteligentes mejoradas, diseño inteligente y mucho más](gems2018/aem-machine-learning.md)
   + [Mantener el código abierto y mantener la cordura](gems2018/aem-maintaining-open-source.md)
   + [Solución de problemas de consultas e índices de AEM (continuación)](gems2018/aem-query-and-index-troubleshooting2.md)
   + [Editor de SPA de AEM](gems2018/aem-spa-editor.md)
   + [Índice de Solr as a Oak para AEM](gems2018/solr-as-an-oak-index-for-aem.md)
   + [SPA Editor SDK deep dive - parte 1 - react](gems2018/spa-editor-sdk-deep-dive-react.md)
   + [SPA Editor SDK deep dive - parte 2 - angular](gems2018/spa-editor-sdk-deep-dive-angular.md)
   + [Uso de OSGi R7 en AEM](gems2018/using-osgi-r7-in-aem.md)
+ 2017 {#gems2017}
   ...
   + [Generar comprobaciones de estado para AEM](gems2017/aem-building-health-checks-for-aem.md)
   + [Desarrollar paquetes y servicios de OSGi para AEM](gems2017/aem-developing-osgi-bundles-services-for-aem.md)
   + [Arquitectura de AEM Dynamic Media 6.3](gems2017/aem-dynamic-media-architecture.md)
   + [Experiencias fluidas de AEM para casos de uso sin encabezado](gems2017/aem-headless-usecases.md)
   + [Indexación de AEM y consulta JCR](gems2017/aem-indexing-jcr-query.md)
   + [Integraciones de AEM](gems2017/aem-integrations.md)
   + [Administrar almacén de datos de AEM](gems2017/aem-managing-aem-datastore.md)
   + [Buscar fácilmente en formularios con querybuilder de AEM](gems2017/aem-search-forms-using-querybuilder.md)
   + [Mantenimiento de AEM: prácticas recomendadas para implementar versiones de mantenimiento de AEM](gems2017/aem-sustenance-best-practices-deploying-maintenance-releases.md)
   ...
   + [Solucionar problemas de replicación de AEM](gems2017/aem-troubleshooting-aem-replication.md)
...
+ 2016 {#gems2016}
   ...
   + [Ejecutar AEM en MongoDB](gems2016/aem-running-aem-on-mongodb.md)
   + [Configuración de Dynamic Media de AEM](gems2016/aem-setup-and-configure-aem-dynamic-media.md)
   ...
   + [Rendimiento web de AEM](gems2016/aem-web-performance.md)
+ 2015 {#gems2015}
   + [Integración y prácticas recomendadas de traducción de AEM 6.1](gems2015/aem-6-1-translation-integration-and-best-practices.md)
   + [Creación de comunidades en línea con AEM 6.1](gems2015/aem-creating-online-communities-with-aem-6-1.md)
   ...
   + [adelantos de AEM Tech](gems2015/aem-tech-sneak-peek.md)
...
+ 2014 {#gems2014}
   + [Implementar Adobe Analytics en una instancia de AEM local mediante el servicio en la nube de DTM](gems2014/aem-adobe-analytics-dynamic-tag-management.md)
   ...
   + [Modo de desarrollador de AEM 6.0](gems2014/aem-developer-mode.md)
   ...
   + [Traducción automática en AEM](gems2014/aem-machine-translation-in-aem.md)
   + [AEM 6 Oak: MongoMK y consultas](gems2014/aem-oak-mongomk-and-queries.md)
   + [Funcionalidad del servidor OAuth en AEM](gems2014/aem-oauth-server-functionality-in-aem.md)
   + [Conector de SharePoint: instalación y configuración](gems2014/aem-sharepoint-connector-setup-and-configuration.md)
   + [Marco del componente social en AEM 6](gems2014/aem-social-component-framework-in-aem-6.md)
   + [Inmersión técnica en la plataforma AEM 6](gems2014/aem-technical-deep-dive-into-the-aem-6-platform.md)
   + [Descripción técnica de la plataforma AEM 6](gems2014/aem-technical-overview-of-the-aem-6-platform.md)
   + [Personalización de la interfaz de usuario para AEM 6](gems2014/aem-user-interface-customization-for-aem6.md)
+ 2013 {#gems2013}
   + [Arquitectura de la plataforma AEM 5.6](gems2013/aem-architecture-of-the-aem-5-6-platform.md)
   + [Solución de problemas de CQ/AEM 5.6](gems2013/aem-cq-aem-5-6-troubleshooting.md)
   + [eCommerce Integration Framework](gems2013/aem-ecommerce-integration-framework.md)
   + [integración del marco de comercio electrónico de hybris/AEM 5.6](gems2013/aem-hybris-ecommerce-framework-integration.md)
   + [Introducción a la gestión y descarga de trabajos en AEM 5.6.1.](gems2013/aem-job-handling-and-offloading.md)
   + [Lanzamientos: preparación simultánea de varias versiones de un sitio web (AEM 5.6)](gems2013/aem-launches.md)
   + [Análisis profundo de AEM 5.6 Media Publisher](gems2013/aem-media-publisher-deep-dive.md)
   + [Administración de metadatos en AEM DAM](gems2013/aem-metadata-management-in-aem-dam.md)
   ...
   + [Mecanismos de actualización de AEM 5.6](gems2013/aem-upgrade-mechanisms.md)
