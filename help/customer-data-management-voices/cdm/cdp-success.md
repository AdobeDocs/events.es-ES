...
Con todo el ruido del mercado sobre las CDP, es difícil saber dónde centrarse y cómo prepararse para el éxito. En esta sesión, Matt Skinner y Kevin Cobourn de Adobe demuestran el valor que un CDP puede proporcionar, proporcionan 5 criterios clave para la evaluación y comparten los pasos que puede tomar hoy para comenzar a prepararse para el éxito de CDP.
